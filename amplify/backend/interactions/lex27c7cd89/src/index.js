...
exports.handler = function(event, context) {
    ...
    let intentParams = [
        ...
        {
            "name": "BookCar_dev" + "_" + process.env.ENV,
        ...
        {
            "name": "BookHotel_dev" + "_" + process.env.ENV,
    ...
    let botParams = {
        ...
        "intents": [
            ...
            {
                "intentName": "BookCar_dev" + "_" + process.env.ENV,
                "intentVersion": "$LATEST"
            },
        
            {
                "intentName": "BookHotel_dev" + "_" + process.env.ENV,
                "intentVersion": "$LATEST"
            },
...
function ensureLambdaFunctionAccess(intent){
    if(intent.fulfillmentLambda){
        ...
        const params = {
            ...
            StatementId: `Lex-${intent.name}`+ "8bd5a6f7",
